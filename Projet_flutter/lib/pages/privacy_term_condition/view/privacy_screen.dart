...
class _PrivacyScreenState extends State<PrivacyScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: ResponsiveGridRow(
          children: [
            _commonCard(_buildPrivacyList(lang)),
          ],
        ),
      ),
    );
  ...
  _buildPrivacyList(AppLocalizations lang) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        final data = controller.privacyPolicyList[index];
        return _buildPrivacyView(data, index, lang);
      },
    );
  }

  _buildPrivacyView(PrivacyTermsData data, int index, AppLocalizations lang) {
